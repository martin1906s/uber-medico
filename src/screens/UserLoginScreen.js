...
export const UserLoginScreen = () => {
  ...
  const handleLogin = () => {
    ...
    setTimeout(() => {
      ...
      // Para testing: permitir login con cualquier email/contraseña válida
      if (form.email && form.password.length >= 6) {
        // Login exitoso
        login(ROLE_TYPES.USER);
      } else {
        Alert.alert(
      ...
      <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
        ...
        >
          ...
          <View style={styles.header}>
            <Ionicons name="person-circle" size={64} color={palette.neon} />
          ...
          <Text style={[styles.footer, dynamicStyles.footer]}>
            Si aún no tienes cuenta, regístrate para comenzar a usar MedicConnect.
          </Text>
        </ScrollView>
      </SafeAreaView>
    </LinearGradient>
